...
//    .init(
//        h1: DBFont.dbFlex.font(size: typo.headline.fontSizeXl),
//        h2: DBFont.dbFlex.font(size: typo.headline.fontSizeLg),
//        h3: DBFont.dbFlex.font(size: typo.headline.fontSizeMd),
//        h4: DBFont.dbFlex.font(size: typo.headline.fontSizeSm),
//        h5: DBFont.dbFlex.font(size: typo.headline.fontSizeXs),
//        h6: DBFont.dbFlex.font(size: typo.headline.fontSize2xs),
//        body: DBFont.dbFlex.font(size: typo.body.fontSizeMd),
//        body3xl: DBFont.dbFlex.font(size: typo.body.fontSize3xl),
//        body2xl: DBFont.dbFlex.font(size: typo.body.fontSize2xl),
//        bodyXl: DBFont.dbFlex.font(size: typo.body.fontSizeXl),
//        bodyLg: DBFont.dbFlex.font(size: typo.body.fontSizeLg),
//        bodyMd: DBFont.dbFlex.font(size: typo.body.fontSizeMd),
//        bodySm: DBFont.dbFlex.font(size: typo.body.fontSizeSm),
//        bodyXs: DBFont.dbFlex.font(size: typo.body.fontSizeXs),
//        body2xs: DBFont.dbFlex.font(size: typo.body.fontSize2xs),
//        body3xs: DBFont.dbFlex.font(size: typo.body.fontSize3xs)
//    )
//}
//
